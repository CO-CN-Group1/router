...
module thinpad_top(
    ...
    input wire[31:0] cpu_data_i_debug,
    output wire[31:0] cpu_data_o_debug,
    input wire[7:0] cpu_addr_debug,
    input wire cpu_ce_debug,
    input wire[3:0] cpu_we_debug*/
);
...
//assign debug_clk = clk_20M;
//assign debug_rst = ~locked;
...
sender_mem sender_mem0(
    ...
    /*.cpu_data_i(cpu_data_i_debug),
    .cpu_data_o(cpu_data_o_debug),
    .cpu_addr(cpu_addr_debug),
    .cpu_ce_n(cpu_ce_debug),
    .cpu_we_n(cpu_we_debug),*/
